		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "chatbot",
									"targetURL": "#chatbotchatbot-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chatbotchatbot-display": {
								"semanticObject": "chatbotchatbot",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chatbot.chatbot",
									"url": sap.ui.require.toUrl("chatbot/chatbot")
								}
							}
						}
					}
